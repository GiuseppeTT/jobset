...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestartGroup) DeepCopyInto(out *RestartGroup) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestartGroup.
func (in *RestartGroup) DeepCopy() *RestartGroup {
	if in == nil {
		return nil
	}
	out := new(RestartGroup)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RestartGroup) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestartGroupList) DeepCopyInto(out *RestartGroupList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]RestartGroup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestartGroupList.
func (in *RestartGroupList) DeepCopy() *RestartGroupList {
	if in == nil {
		return nil
	}
	out := new(RestartGroupList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *RestartGroupList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestartGroupSpec) DeepCopyInto(out *RestartGroupSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestartGroupSpec.
func (in *RestartGroupSpec) DeepCopy() *RestartGroupSpec {
	if in == nil {
		return nil
	}
	out := new(RestartGroupSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestartGroupStatus) DeepCopyInto(out *RestartGroupStatus) {
	*out = *in
	if in.LiftBarrierStartedBeforeOrAt != nil {
		in, out := &in.LiftBarrierStartedBeforeOrAt, &out.LiftBarrierStartedBeforeOrAt
		*out = (*in).DeepCopy()
	}
	if in.RestartWorkerStartedBeforeOrAt != nil {
		in, out := &in.RestartWorkerStartedBeforeOrAt, &out.RestartWorkerStartedBeforeOrAt
		*out = (*in).DeepCopy()
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestartGroupStatus.
func (in *RestartGroupStatus) DeepCopy() *RestartGroupStatus {
	if in == nil {
		return nil
	}
	out := new(RestartGroupStatus)
	in.DeepCopyInto(out)
	return out
}
