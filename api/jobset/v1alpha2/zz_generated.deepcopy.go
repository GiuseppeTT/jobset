...
func (in *RestartGroupSpec) DeepCopyInto(out *RestartGroupSpec) {
	*out = *in
	in.WorkerPodSelector.DeepCopyInto(&out.WorkerPodSelector)
}
...
func (in *RestartGroupStatus) DeepCopyInto(out *RestartGroupStatus) {
	*out = *in
	if in.RestartStartedAt != nil {
		in, out := &in.RestartStartedAt, &out.RestartStartedAt
		*out = (*in).DeepCopy()
	}
	if in.RestartFinishedAt != nil {
		in, out := &in.RestartFinishedAt, &out.RestartFinishedAt
		*out = (*in).DeepCopy()
	}
}
