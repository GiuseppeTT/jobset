...
class JobsetV1alpha2JobSetStatus(BaseModel):
    ...
    current_in_place_restart_attempt: Optional[StrictInt] = Field(default=None, description="currentInPlaceRestartAttempt tracks the current in-place restart attempt of the JobSet. It is read by the agent sidecar. If the in-place restart attempt of the Pod is equal to currentInPlaceRestartAttempt, the agent sidecar should lift its barrier to allow the worker container to start running.", alias="currentInPlaceRestartAttempt")
